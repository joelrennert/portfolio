<template>
  ...
  >
    <div class="projectImage" :class="{ rotate: rotated }">
      <img src="../assets/cubes4.png" class="heroImage" />
    </div>
    <div class="rightSide">
      <div class="h2Text">
        <h2 class="wideh2">web design</h2>
        <!-- <h2>layouts</h2> -->
      </div>
      <div class="heroText">
        <p>Layout & prototyping</p>
      </div>
...
.hero {
  ...
  background-color: #6eac7adc;
  /* background-color: #4f4c47; */
  border-radius: 20px;
  padding: 10px;
  opacity: 0; /* Initial visibility */
}
...
.hero.clicked {
  ...
  opacity: 1; /* Ensures visibility after fade-in */
}
